                                                ...
                                                {{-- @if(auth()->check())
                                                    @if(in_array($lesson->model->id,$completed_lessons)) --}}
                                                        ...
                                                        @endphp
                                                            ...
                                                            <!-- <span class="gradient-bg p-1 text-white font-weight-bold completed">@if($lesson->course->progress() == '100') @lang('labels.frontend.course.completed') @else {{$lesson->course->progress()}}% @endif</span> -->
                                                        </div>
                                                    {{-- @endif
                                                @endif --}}
                                                    ...
                                                    <div class="ac-head">
                                                        ...
                                                        @if($lesson->model_type == 'App\Models\Test')
                                                            <div class="leanth-course">
                                                                <a class="btn btn-sm btn-warning" href="{{route('lessons.show',['course_id' => $lesson->course->id,'slug'=>$lesson->model->slug])}}">
