                                    ...
                                    <div class=" row clone_condition logic_condition_{{ $ii }}" style="padding-top:10px;">
                                        <div class="row col-12" style="padding-top:10px;">
                                            ...
                                            <div class="col-12 logic-content" style="padding-top:10px">
                                                    ...
                                                    <div class="row  main-content" id="cond_{{$question_infos[$target]->id}}"  > 
                                                        <div class="col-12 form-group  logic_check" style="margin-left:20px;">
                                                            ...
                                                            ?>
                                                                <div  class="checkbox">
                                                                    @if ( $check_vals[$num] > 0)
                                                                        <label><input type="checkbox" class="checkbox_{{ $num }} value="{{$content[$num]->score}}"" checked>{{ $content[$num]->label }}</label>
                                                                    @else
                                                                        <label><input type="checkbox"  class="checkbox_{{ $num }}" value="{{$content[$num]->score}}">{{ $content[$num]->label }}</label>
                                                                    @endif
                                                                </div>
                                                            @endfor    
                                                        </div>           
                                                ...
                                                @elseif($question_infos[$target]->questiontype == 2 || $question_infos[$target]->questiontype == 6)
                                                    <div class="row main-content" id="cond_{{$question_infos[$target]->id}}"  > 
