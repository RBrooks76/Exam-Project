    ...
    @if(isset($content))
        ...
        <div class="col-12  form-group " id="sortable_drop1">
            ...
            <div class="radio">
                ...
                <label>Step</label>
                <input id="step_value" type="text"  class ="radio_score mr-2" placeholder="{{$question->score}}">
            </div>
        </div>
        <div class="col-12">
        ...
        <div class="form-group">
            ...
            <select id="range_type" class="form-control">
                <option value="1" @if($content->symbol=="1") selected @endif>Cursor Bar</option>
                <option value="2" @if($content->symbol=="2") selected @endif>+/- Button</option>
            </select>
        </div>
    </div>
    @else
