...
var ChartCreate = function () {
    ...
    var ExpressionCalculation = function(){
        ...
        //e.preventDefault();
        $.ajax({
            data: {question_list:question_list,textgroup_list:textgroup_list},
...
function selectQuestion(e,data_testid,data_count) {
    if(data_count != null) {
        ...
        /*$.ajax({
            data: {question_list1:selected_val,data_testid:data_testid,data_count:data_count},
            url: "get_table",
            type: "GET",
            //dataType: 'json',
            success: function(response){
                $("#"+selectedItemID).val(response);
            },
            error: function(response){
                console.log(response);
            }
